        ...
        <section>
            <button class="button is-info is-small compose" type="button" @click="show = !show">Compose</button>
                ...
                <form name="pmForm" id="pmForm" v-if="show" >  
                    ...
                    <textarea  class="textarea is-small" v-model="composedEmail.body" name="pmBody" id="pmBody" type="text" maxlength="64" style="width:98%;" placeholder="Enter email body"></textarea>
